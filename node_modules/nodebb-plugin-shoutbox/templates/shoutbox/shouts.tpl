<!-- BEGIN shouts -->
<div class="shout {shouts.typeClasses}">
    <!-- IF shouts.showTime -->
    <div class="shout-timespan">
        {shouts.debugTs} - {shouts.debugLt}
        <span class="time timeago timeago-update" title="{shouts.timeString}">{shouts.timeString}</span>
    </div>
    <!-- ENDIF shouts.showTime -->
    <!-- IF !shouts.isChained -->
    ...
    <div class="shoutbox-shout {shouts.typeClasses}" data-sid="{shouts.sid}" data-uid="{shouts.fromuid}">
        ...
        <!-- IF shouts.isMine -->
            <svg class="shout-tip" viewBox="0 0 1 1">
              <path d="M 1 0 H 0 V 1 C 0 0, 1 0, 1 0"></path>
            </svg>
        <!-- ELSE -->
            <svg class="shout-tip" viewBox="0 0 1 1">
              <path d="M 0 0 H 1 V 1 C 1 0, 0 0, 0 0"></path>
            </svg>
        <!-- ENDIF shouts.isMine -->
    </div>
